  ...
  <div class="single-page">
    ...
    <div class="form">
      ...
      <form action="<?php self() ?>" method="POST">
        ...
        <div class="form-group">
          <textarea class="bio-text" name="user_bio" placeholder="Write something about yourself..."><?php
						if($user_info->user_bio) {
							echo $user_info->user_bio;
						} else {
							echo '';
						}
					?></textarea>
        ...
        <div class="form-group">
          ...
          <input id="submit" type="submit" name="update_bio" value="Update">
        </div>
      </form>
    </div>
    <div class="form">
